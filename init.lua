...
vim.keymap.set({"n"}, "^", "g^", noremap)
vim.keymap.set({"n"}, "$", "g$", noremap)
vim.keymap.set({"n"}, "0", "g0", noremap)
vim.keymap.set({"n"}, "g0", "0", noremap)
vim.keymap.set({"n"}, "g^", "^", noremap)
vim.keymap.set({"n"}, "g$", "$", noremap)
vim.keymap.set({"n", "x"}, "j", "gj", noremap)
vim.keymap.set({"n", "x"}, "k", "gk", noremap)
vim.keymap.set({"n", "x"}, "gj", "j", noremap)
vim.keymap.set({"n", "x"}, "gk", "k", noremap)
...
map("n", "<Leader>:w", [[':write '.expand("%")]], expr)
map("n", "<Leader>:W", [[':write '.expand("%:h")]], expr)
map("n", "<Leader>!s", [[':saveas! '.expand("%")]], expr)
map("n", "<Leader>!S", [[':saveas! '.expand("%:h")]], expr)
map("n", "<Leader>!w", [[':write! '.expand("%")]], expr)
map("n", "<Leader>!W", [[':write! '.expand("%:h")]], expr)
